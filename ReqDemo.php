             ...
             <form action="" method="post" class="credit-card">
                 <div class="user-details">
                     <div class="input-box">
                         ...
                         <input type="text" placeholder="Enter your name" name="firstname" pattern="[A-Za-z]{1,32}"
                             title="must be only letters" required />
                     </div>
                     <div class="input-box">
                         <span class="details">Last Name</span>
                         <input type="text" placeholder="Enter your lastname" name="lastname" pattern="[A-Za-z]{1,32}"
                             title="must be only letters" required />
                     </div>
                     <div class="input-box">
                     ...
                     <div class="input-box">
                         ...
                         <input type="text" placeholder="Enter your number" required id="phoneno1" name="phoneno"
                             pattern="[7-9]{1}[0-9]{9}" title="mobile number must be valid" required />
                     </div>
                     <div class="input-box">
                         <span class="details">Password</span>
                         <input type="password" placeholder="Enter your password" id="password1" name="password"
                     ...
                     <div class="input-box">
                         ...
                         <input type="password" placeholder="Confirm your password" id="cpassword2" name="cpassword"
                             required />
                     </div>
                 </div>
