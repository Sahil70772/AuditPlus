...
<body>
  ...
  <h1>Previous Year Audit Data Dashboard</h1>
   <div class="ab">
      <h3>Institution</h3>
      <h6><?php echo $InstitutionCount?></h6></div>
      <div class="ab">
      <h3>Teaching and Learning Strategy</h3>
      <h6><?php echo $TeachingandLearningStrategyCount?></h6></div>
      <div class="ab">
      <h3>Library</h3>
      <h6><?php echo $LibraryCount?></h6></div>
      <div class="ab">
      <h3>Placement Cell</h3>
      <h6><?php echo $PlacementCellCount?></h6></div>
      <div class="ab">
      <h3>Students Support</h3>
      <h6><?php echo $StudentsSupportCount?></h6>
            </div>
            <div class="ab">
      <h3>Information Technology</h3>
      <h6><?php echo $InformationTechnologyCount?></h6></div>
      <div class="ab">
      <h3>College Infrastructure</h3>
      <h6><?php echo $CollegeInfrastructureCount?></h6></div>
              </center>
    ...
    <script>
      var institution = '<?=$InstitutionCount?>';
      var teachingandlearningstrategy = '<?=$TeachingandLearningStrategyCount?>';
      var library = '<?=$LibraryCount?>';
      var placementcell = '<?=$PlacementCellCount?>';
      var studentssupport= '<?=$StudentsSupportCount?>';
      var informationtechnology = '<?=$InformationTechnologyCount?>';
      var collegeinfrastructure = '<?=$CollegeInfrastructureCount?>';

      var xValues =["Institution", "Teaching and Learning Strategy","Library","PlacementCell","StudentsSupport","InformationTechnology","CollegeInfrastructure"];
      var yValues = [institution, teaching and learning strategy, library, placementcell, studentssupport, informationtechnology, collegeinfrastructure];
