...
<body>
  ...
  <h1>Previous Year Audit Data Dashboard</h1>
   <div class="ab">
      ...
      <h6><?php echo $InfrastructureCount?></h6></div>
      <div class="ab">
      <h3>Safety</h3>
      <h6><?php echo $SafetyCount?></h6></div>
      <div class="ab">
      <h3>Cleanliness</h3>
      <h6><?php echo $CleanlinessCount?></h6></div>
      <div class="ab">
      <h3>Staff Points</h3>
      <h6><?php echo $StaffPointsCount?></h6></div>
      <div class="ab">
      <h3>Maintenance</h3>
      <h6><?php echo $MaintenanceCount?></h6>
            </div>
      <div class="ab">
      <h3>Food Management</h3>
      <h6><?php echo $FoodManagementCount?></h6>
            </div>
      <div class="ab">
      <h3>Information Technology</h3>
      <h6><?php echo $InformationTechnologyCount?></h6>
            </div>
              </center>
    ...
    <script>
      var infrastructure = '<?=$InfrastructureCount?>';
      var safety = '<?=$SafetyCount?>';
      var cleanliness = '<?=$CleanlinessCount?>';
      var staffpoints = '<?=$StaffPointsCount?>';
      var maintenance = '<?=$MaintenanceCount?>';
      var foodmanagement = '<?=$FoodManagementCount?>';
