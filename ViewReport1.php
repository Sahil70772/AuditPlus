...
<body>
  ...
  <h1>Previous Year Audit Data Dashboard</h1>
   <div class="ab">
      <h3>Raw Material Standards</h3>
      <h6><?php echo $RawMaterialStandardsCount?></h6></div>
      <div class="ab">
      <h3>Documentation of Processes</h3>
      <h6><?php echo $DocumentationofProcessesCount?></h6></div>
      <div class="ab">
      <h3>Quality of the Product and Uniformity of Performance</h3>
      <h6><?php echo $QualityoftheProductandUniformityofPerformanceCount?></h6></div>
      <div class="ab">
      <h3>Storage,Packaging and Preservation</h3>
      <h6><?php echo $StoragePackagingandPreservationCount?></h6></div>
      <div class="ab">
      <h3>Safety of Employee</h3>
      <h6><?php echo $SafetyofEmployeeCount?></h6>
            </div>
              </center>
    ...
    <script>
      var RawMaterialStandards = '<?=$RawMaterialStandardsCount?>';
      var DocumentationofProcesses = '<?=$DocumentationofProcessesCount?>';
      var QualityoftheProductandUniformityofPerformance = '<?=$QualityoftheProductandUniformityofPerformanceCount?>';
      var StoragePackagingandPreservation = '<?=$StoragePackagingandPreservationCount?>';
      var SafetyofEmployee = '<?=$SafetyofEmployeeCount?>';
      var xValues =["RawMaterialStandards", "DocumentationofProcesses","QualityoftheProductandUniformityofPerformance","StoragePackagingandPreservation","SafetyofEmployee"];
      var yValues = [rawmaterialstandards, documentationofprocesses, qualityoftheproductanduniformityofperformance, storagepackagingandpreservation, safetyofemployee];
