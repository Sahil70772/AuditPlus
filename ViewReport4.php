...
<body>
  ...
  <h1>Previous Year Audit Data Dashboard</h1>
   <div class="ab">
      <h3>General</h3>
      <h6><?php echo $GeneralCount?></h6></div>
      <div class="ab">
      <h3>Accommodation</h3>
      <h6><?php echo $AccommodationCount?></h6></div>
      <div class="ab">
      <h3>Kitchen</h3>
      <h6><?php echo $KitchenCount?></h6></div>
      <div class="ab">
      <h3>Toilets</h3>
      <h6><?php echo $ToiletsCount?></h6></div>
      <div class="ab">
      <h3>Miscellaneous</h3>
      <h6><?php echo $MiscellaneousCount?></h6>
            </div>
            <div class="ab">
      <h3>Security</h3>
      <h6><?php echo $SecurityCount?></h6></div>
      <div class="ab">
      <h3>Hotel Amenities</h3>
      <h6><?php echo $HotelAmenitiesCount?></h6></div>
      <div class="ab">
      <h3>Tourism Facility</h3>
      <h6><?php echo $TourismFacilityCount?></h6></div>
              </center>
    ...
    <script>
      var general = '<?=$GeneralCount?>';
      var accommodation = '<?=$AccommodationCount?>';
      var kitchen = '<?=$KitchenCount?>';
      var toilets = '<?=$ToiletsCount?>';
      var miscellaneous = '<?=$MiscellaneousCount?>';
      var security = '<?=$SecurityCount?>';
      var hotelamenities = '<?=$Hotel AmenitiesCount?>';
      var tourismfacility = '<?=$Tourism FacilityCount?>';
      var xValues =["General", "Accommodation","Kitchen","Toilets","Miscellaneous","Security","Hotel Amenities","Tourism Facility"];
      var yValues = [general, accommodation, kitchen, toilets, miscellaneous, security, hotel amenities,tourism facility];
